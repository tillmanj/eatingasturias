...
sidebar:
    nav: recipe_full
title: Fabes con Pitu Caleya
permalink: /recipes/meat/chicken/fabes-con-pitu-caleya/
subtitle: homey farmhouse stew with beans and yardbird
author: Jon Tillman
dateCreated: null
datePublished: null
dateModified: null
...
indexIngredients:
    ...
    - Pimentón
recipeIngredients:
    - 500g dry Fabes de Granja (or Cannellini beans)
...
requires:
    - null
recipeInstructions:
    - Place 500g of beans in your crockpot and salt liberally
    - Cook on low (or auto) setting overnight (8-10 hours)
    - Drain the beans and allow them to cool completely before moving on to the chicken. (They can also be refrigerated for a day if you want to make them ahead.)
    - Heat oil in a skillet. 15cl or so of neutral oil in a large cast iron skillet. Heat over medium-high heat until shimmering.
    - Rinse and pat dry three chicken thigh quarters. Of course, if you have a whole chicken, you can simply quarter it yourself and save one third for another recipe.
    - Season the chicken. Rub the chicken pieces with salt, white or black pepper, and smoked paprika.
    - Sear the chicken. Arrange the chicken pieces in the skillet so that they do not overlap. Over medium-high heat cook for 5 minutes on one side. Flip them over and sear the other side for five more minutes.
    - Deglaze the pan. Squirt a little apple cider vinegar into the pan and loosen and crusty bits with a wooden spoon.
    - Stew the chicken. Reduce the heat to low, add the garlic, onion, white wine, and enough water to cover half the chicken. Put the lid on the skillet and let it stew for 30-40 minutes.
    - Remove the chicken pieces to a bowl to cool.
    - Combine the stew broth and beans. You can do this in your skillet if it is large enough. I normally use a large soup pot for this step. If you have held your beans in the fridge, now is the time to gently warm them through once combined with the broth from the chicken.
    - Debone cooked chicken. Remove the skin and gently prize all of the meat away from the bone. Aim for finger sized or smaller pieces. The meat can go directly into the broth and bean pot. I reserve the skin, bones, cartilage, tendons, and gristle for making stock. Alternatively, you can bag them for the trash.
    - Heat the stew. With the meat now all added to the stew, stir it once or twice and wait for it to come up to serving temperature.
    - Serve and enjoy! I sprinkle some chopped parsley on top as a garnish. Alternatively, crack some black pepper on it. Serve with warm crusty bread.
recipeNotes:
